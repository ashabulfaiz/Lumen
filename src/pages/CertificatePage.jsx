...
export default function CertificatePage() {
  ...
  const handleDownloadPDF = async () => {
    ...
    // Simpan zoom original dan paksa ke 1 untuk capture PDF berkualitas A4 penuh
    ...
    try {
      ...
      // Kembalikan zoom original ke style CSS responsif
  ...
  return (
    <div className="mx-auto max-w-[880px] pb-12 pt-2 font-sans space-y-6">
      {/* CSS untuk mencetak sertifikat dan font custom */}
      <style>{`

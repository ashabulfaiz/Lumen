      ...
      <div className="mx-auto max-w-3xl px-4 py-8 font-sans">
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="mt-6 rounded-2xl bg-slate-50 p-5">
            ...
            <p className="mt-1 text-4xl font-bold text-blue-600">{result.score}</p>
            <p className="mt-2 text-sm text-slate-600">
              Correct answers: {result.correctAnswers} of {totalQuestions}
            </p>
            <p className="mt-4 text-[15px] font-medium text-slate-700">
              Recommended Level: <span className="font-bold text-blue-600">{levelName}</span>
            </p>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
        ...
        <div className="mt-7 border-t border-slate-200 pt-5">
          <div className="flex items-center justify-between gap-4">
            ...
            <button
              type="button"
              className={`inline-flex items-center gap-2 rounded-xl px-2 py-1 text-sm font-medium transition ${canProceed ? 'text-blue-600 hover:text-blue-700' : 'cursor-not-allowed text-slate-300'
                }`}
              onClick={handleNext}
              disabled={!canProceed}
            >
